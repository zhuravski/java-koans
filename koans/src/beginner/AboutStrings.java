...
public class AboutStrings {
    ...
    public void implicitStrings() {
        assertEquals("just a plain ole string".getClass(), "another plain string".getClass());
    }
    ...
    public void insufficientArgumentsToStringFormatCausesAnError() {
        try {
            ...
            assertEquals(e.getClass(), new java.util.MissingFormatArgumentException("").getClass());
